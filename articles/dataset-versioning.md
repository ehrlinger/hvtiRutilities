...
alias. Review verifies both files and shows row, column, type, and label
changes. Adoption repeats those checks, then replaces `_study.yml` and
`manifest.yaml` together. It leaves the old dated file in place.
