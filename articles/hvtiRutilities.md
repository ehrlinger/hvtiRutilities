...
#>  $ boolean: int  2 1 2 1 1 2 1 2 2 2 ...
#>   ..- attr(*, "label")= chr "Binary Indicator"
#>  $ logical: chr  "T" "F" "T" "F" ...
#>   ..- attr(*, "label")= chr "Logical Status"
#>  $ f_real : num  0.513 0.41 0.839 0.41 0.541 ...
#>   ..- attr(*, "label")= chr "Random Uniform Value"
#>  $ float  : num  -0.522 1.224 -0.294 0.671 1.471 ...
#>   ..- attr(*, "label")= chr "Random Normal Value"
#>  $ char   : chr  "male" "male" "male" "male" ...
#>   ..- attr(*, "label")= chr "Gender"
#>  $ factor : Factor w/ 5 levels "C1","C2","C3",..: 5 4 3 1 1 4 1 4 2 2 ...
...
#>   ..- attr(*, "label")= chr "Binary Indicator"
#>  $ logical: Factor w/ 2 levels "F","T": 2 1 2 1 1 2 1 2 2 2 ...
#>   ..- attr(*, "label")= chr "Logical Status"
#>  $ f_real : Factor w/ 9 levels "0.19542964710854",..: 5 4 9 4 6 6 6 1 4 9 ...
#>   ..- attr(*, "label")= chr "Random Uniform Value"
#>  $ float  : num  -0.522 1.224 -0.294 0.671 1.471 ...
#>   ..- attr(*, "label")= chr "Random Normal Value"
#>  $ char   : Factor w/ 2 levels "female","male": 2 2 2 2 1 1 1 1 2 2 ...
#>   ..- attr(*, "label")= chr "Gender"
#>  $ factor : Factor w/ 5 levels "C1","C2","C3",..: 5 4 3 1 1 4 1 4 2 2 ...
#>   ..- attr(*, "label")= chr "Category Group"
```
...
#> [1] labelled_2.16.0      hvtiRutilities_1.0.5
#> 
