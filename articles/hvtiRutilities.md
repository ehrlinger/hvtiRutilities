...
#>  $ boolean: int  2 1 1 1 1 1 1 1 1 1 ...
#>   ..- attr(*, "label")= chr "Binary Indicator"
#>  $ logical: chr  "T" "F" "F" "F" ...
#>   ..- attr(*, "label")= chr "Logical Status"
#>  $ f_real : num  0.2092 0.0913 0.0913 0.5498 0.8058 ...
#>   ..- attr(*, "label")= chr "Random Uniform Value"
#>  $ float  : num  -0.154 0.381 -1.974 -1.264 0.914 ...
#>   ..- attr(*, "label")= chr "Random Normal Value"
#>  $ char   : chr  "male" "male" "female" "female" ...
#>   ..- attr(*, "label")= chr "Gender"
#>  $ factor : Factor w/ 5 levels "C1","C2","C3",..: 1 5 5 3 2 5 2 5 1 3 ...
...
#>   ..- attr(*, "label")= chr "Binary Indicator"
#>  $ logical: Factor w/ 2 levels "F","T": 2 1 1 1 1 1 1 1 1 1 ...
#>   ..- attr(*, "label")= chr "Logical Status"
#>  $ f_real : Factor w/ 9 levels "0.0166096345055848",..: 3 2 2 5 8 2 9 8 6 2 ...
#>   ..- attr(*, "label")= chr "Random Uniform Value"
#>  $ float  : num  -0.154 0.381 -1.974 -1.264 0.914 ...
#>   ..- attr(*, "label")= chr "Random Normal Value"
...
#> [1] labelled_2.16.1      hvtiRutilities_1.1.5
#> 
