...
#>  $ boolean: int  1 2 1 1 2 1 1 2 2 1 ...
#>   ..- attr(*, "label")= chr "Binary Indicator"
#>  $ logical: chr  "F" "T" "F" "F" ...
#>   ..- attr(*, "label")= chr "Logical Status"
#>  $ f_real : num  0.841 0.798 0.937 0.636 0.606 ...
#>   ..- attr(*, "label")= chr "Random Uniform Value"
#>  $ float  : num  0.647 -1.236 -0.232 -0.493 0.817 ...
#>   ..- attr(*, "label")= chr "Random Normal Value"
#>  $ char   : chr  "female" "male" "male" "male" ...
#>   ..- attr(*, "label")= chr "Gender"
#>  $ factor : Factor w/ 5 levels "C1","C2","C3",..: 4 1 4 1 2 3 3 2 2 4 ...
...
#>   ..- attr(*, "label")= chr "Binary Indicator"
#>  $ logical: Factor w/ 2 levels "F","T": 1 2 1 1 2 1 1 2 2 1 ...
#>   ..- attr(*, "label")= chr "Logical Status"
#>  $ f_real : Factor w/ 9 levels "0.504105147439986",..: 8 5 9 3 2 5 2 9 8 9 ...
#>   ..- attr(*, "label")= chr "Random Uniform Value"
#>  $ float  : num  0.647 -1.236 -0.232 -0.493 0.817 ...
#>   ..- attr(*, "label")= chr "Random Normal Value"
#>  $ char   : Factor w/ 2 levels "female","male": 1 2 2 2 2 2 2 2 1 1 ...
#>   ..- attr(*, "label")= chr "Gender"
#>  $ factor : Factor w/ 5 levels "C1","C2","C3",..: 4 1 4 1 2 3 3 2 2 4 ...
#>   ..- attr(*, "label")= chr "Category Group"
