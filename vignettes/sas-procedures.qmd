...
`PROC FREQ` to see whether the categories look right: how many died, how the
cohort splits across the groups you will compare.
...
The point is that you already know what these three tables should look like, and
