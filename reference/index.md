...
- [`proc_univariate()`](https://ehrlinger.github.io/hvtiRutilities/reference/proc_univariate.md)
  : Summarise and test numeric variables, in the style of SAS PROC
  UNIVARIATE
...
Snapshot a study’s code at each checkpoint, record its documents by
checksum, and record its closure
...
Sweep the job corpus by filename – which studies ran which job types
...
- [`job_census()`](https://ehrlinger.github.io/hvtiRutilities/reference/job_census.md)
  [`print(`*`<hvti_job_census>`*`)`](https://ehrlinger.github.io/hvtiRutilities/reference/job_census.md)
  : Roll a job-file inventory up to studies and prefixes

## Candidate Pool Preparation

Getting a covariate list out of a SAS job and into a model without
changing the model on the way. Each of these exists because of a failure
that was silent: a comment swallowing a variable name, a mean-imputed
binary being dummy-coded, a screen spending its step budget on five
forms of one concept, a rank-deficient design from two names for the
same thing.
...
- [`POOL_AFFIXES`](https://ehrlinger.github.io/hvtiRutilities/reference/pool_conventions.md)
  [`POOL_PLAIN_SUFFIX`](https://ehrlinger.github.io/hvtiRutilities/reference/pool_conventions.md)
  [`POOL_MIN_STEM`](https://ehrlinger.github.io/hvtiRutilities/reference/pool_conventions.md)
